                  ...
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle"><?php echo e(number_format($customer)); ?></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">$<?php echo e(number_format($revenue)); ?></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle"><?php echo e(number_format($transaction_count)); ?></div>
                      </div>
                    </div>
                  </div>
                </div>
